...
PulsingPlanetShader::~PulsingPlanetShader()
{
...
void PulsingPlanetShader::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void PulsingPlanetShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, Timer* timer)
{
	HRESULT result;
...
void PulsingPlanetShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
